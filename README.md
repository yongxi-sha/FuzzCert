...
```
def register_fadapter(self) -> None:
    # Local import avoids circulars
    from falsify_adapter import FalsifyAdapter
    from myfunc_adapter import MyFuncAdapter

    self.fadapters = {
        "falsify": FalsifyAdapter,
        "myfunc":  MyFuncAdapter,   # ← your new function
    }
```
...
```
If the input generated by custom mutator is over the default length()